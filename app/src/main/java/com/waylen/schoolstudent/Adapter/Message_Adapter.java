...
public class Message_Adapter extends RecyclerView.Adapter<Message_Adapter.MyViewHolder> {
    ...
    public Message_Adapter(Context context, List<Map<String, Object>> baselist) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        myview = new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.message_adapter, null));
...
//            holder.time_Txt.setText(StaticData.Datatypetwo(baselist.get(position - 1).get("date").toString()));
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            adapter_rel.setPadding(pad, pad, pad, pad);
        }
    }
