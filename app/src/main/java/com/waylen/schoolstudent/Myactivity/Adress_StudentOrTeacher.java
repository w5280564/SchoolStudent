...
import com.waylen.schoolstudent.Adapter.StudentOrTeacher_Adapter;
 ...
 */
public class Adress_StudentOrTeacher extends myActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (UrlVO.getShareData("card", this).equals("老师")){
            base_title_Txt.setText("老师");
        }else{
            base_title_Txt.setText("学生");
        }
...
//        onLoadMore();
        initlist();
//teaLeaveSW-list.action


//        DoingWorkData("http://swfx.sinthonic.com/swfx/teaLeaveSW-list.action", courseType, "0");
...
//            NewsList(UrlVO.BaseUrl + UrlVO.NewsListUrl);
            ...
            Toast.makeText(Adress_StudentOrTeacher.this, "Refresh Finsh", Toast.LENGTH_SHORT).show();
        }
    }
...
//    }
    ...
    private StudentOrTeacher_Adapter mAdapter;
    ...
    public void initlist() {
        ...
        mAdapter = new StudentOrTeacher_Adapter(this, notifyArr);
        my_recyclerview.setAdapter(mAdapter);
        mAdapter.setOnItemClickLitener(new StudentOrTeacher_Adapter.OnItemClickLitener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent i = new Intent(Adress_StudentOrTeacher.this,Adress_StudentOrTeacher_Data.class);
                startActivity(i);
            }
