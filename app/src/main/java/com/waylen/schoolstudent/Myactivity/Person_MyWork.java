...
import com.waylen.schoolstudent.Adapter.personMyWork_Adapter;
 ...
 */
public class Person_MyWork extends myActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.person_mywork);
...
//            NewsList(UrlVO.BaseUrl + UrlVO.NewsListUrl);
            ...
            Toast.makeText(Person_MyWork.this, "Refresh Finsh", Toast.LENGTH_SHORT).show();
        }
    }
...
//    }
    ...
    private personMyWork_Adapter mAdapter;
    ...
    public void initlist() {
        ...
        mAdapter = new personMyWork_Adapter(this, notifyArr);
        my_recyclerview.setAdapter(mAdapter);
        mAdapter.setOnItemClickLitener(new personMyWork_Adapter.OnItemClickLitener() {
            @Override
