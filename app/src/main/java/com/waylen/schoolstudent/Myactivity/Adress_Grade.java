...
import com.waylen.schoolstudent.Adapter.Grade_Adapter;
 ...
 */
public class Adress_Grade extends myActivity {
...
//            NewsList(UrlVO.BaseUrl + UrlVO.NewsListUrl);
            ...
            Toast.makeText(Adress_Grade.this, "Refresh Finsh", Toast.LENGTH_SHORT).show();
        }
    }
...
//    }
    ...
    private Grade_Adapter mAdapter;
    ...
    public void initlist() {
        ...
        mAdapter = new Grade_Adapter(this, notifyArr);
        my_recyclerview.setAdapter(mAdapter);
        mAdapter.setOnItemClickLitener(new Grade_Adapter.OnItemClickLitener() {
            @Override
            public void onItemClick(View view, int position) {
                Intent i = new Intent(Adress_Grade.this,Adress_Class.class);
                startActivity(i);
            }
